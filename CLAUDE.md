...
**Status (2026-04-28):** Live im Produktivsystem seit 2026-04-17. MVP komplett, plus User-Override-Layer, mobile_app silent-reject Catcher und **4-Schichten-Push-Resilienz** (Sanity-Check für `payload.data.data`, Retry ohne Payload bei warnung/kritisch, `persistent_notification`-Notbremse bei Total-Ausfall kritischer Meldungen). 13 Services, 9 Sensoren, 2 Custom Cards. GitHub: https://github.com/cnc-lasercraft/ha-herold
